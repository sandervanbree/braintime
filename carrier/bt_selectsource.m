...
%
% Use:
% [bt_source] = bt_selectsource(config,fft_sources,warpsources)
%
% Input Arguments:
% config
...
if isfield(config,'layout')
    ranktype = 'topography and maximum power at frequencies of interest.';
else
    ranktype = 'maximum power at frequencies of interest.';
end
