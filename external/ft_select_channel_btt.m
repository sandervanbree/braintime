function ft_select_channel_btt(handle, eventdata,  varargin)
% Copyright (C) 2009, Robert Oostenveld  
%
% Modified for the Brain Time Toolbox by María Melcón and Sander van Bree
%
%
...
if any(select)
  ...
  temptopo = label; %transform the selected sensors into 5's
