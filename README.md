...
| Step  | *First level* stats ([bt_statslevel1](periodicity/bt_statslevel1.m)) algorithm |
| --- | :-- |
...
| Step  | *Second level* stats ([bt_statslevel2](periodicity/bt_statslevel2.m)) algorithm |
| --- | :-- |
