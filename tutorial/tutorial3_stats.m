%%% In tutorial 2 we quantified recurrence in one dataset. In this tutorial
%%% we will perform a two level statistical analysis with four dummy
%%% participants to test for TGM recurrence across all participants.
